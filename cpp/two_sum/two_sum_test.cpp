...
TEST(twoSum, checkTwoSum) {
    ...
    EXPECT_EQ(testObject.twoSum(testCase1Set, 9), testCase1Result);
    EXPECT_EQ(testObject.twoSum(testCase2Set, 6), testCase2Result);
    EXPECT_EQ(testObject.twoSum(testCase3Set, 14), testCase3Result);
}
